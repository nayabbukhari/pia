    ...
    <div class="">
     <div class="panel panel-default">
      <?php include("connection.php");
				...
				$query = mysqli_query($con,"select * from pia_people where id='".$_GET['id']."' order by date_time desc") ;
                $i = 1;
				...
				?>
      <form class="no-margin" id="formValidate2" data-validate="parsley" method="post" action="#" name="client_record" enctype="multipart/form-data" novalidate>
        <div class="panel-heading"><i class="fa fa-user fa-lg"></i>  Edit People<span><a href="people.php">Cancel</a></span></div>
           ...
           <div class="row">
            <div class="col-md-6" id="right_border">
              <div class="form-group">
                ...
                <input type="text" placeholder="Person ID" class="form-control input-sm parsley-validated" readonly value="<?php echo $row['people_id']; ?>" data-required="true" name="people_id">
              </div>
            </div>
            <!-- /.col -->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="Phone" class="form-control input-sm parsley-validated " value="<?php echo $ph; ?>" data-required="true" name="phone">
           ...
           <div class="row">
            <div class="col-md-6" id="right_border">
              <div class="form-group">
                ...
                <input type="text" placeholder="First name" class="form-control input-sm parsley-validated" value="<?php echo $row['firstname']; ?>" data-required="true" name="firstname">
              </div>
            </div>
            <!-- /.col -->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="Address" value="<?php echo $row['address']; ?>" class="form-control input-sm parsley-validated " data-required="true" name="Address">
              </div>
            </div>
            <!-- /.col --> 
          </div>
          ...
          <div class="row">
            <div class="col-md-6" id="right_border">
              <div class="form-group">
                ...
                <input type="text" placeholder="Last name" value="<?php echo $row['lastname']; ?>" class="form-control input-sm parsley-validated " data-required="true" name="lastname">
              </div>
            </div>
            <!-- /.col -->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="City" value="<?php echo $row['city']; ?>" class="form-control input-sm parsley-validated " data-required="true" name="City">
              </div>
            </div>
            <!-- /.col --> 
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6" id="right_border">
              <div class="form-group">
                ...
                <input type="email" placeholder="Email" value="<?php echo $row['email']; ?>" class="form-control input-sm parsley-validated " data-required="true" name="email">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="text" placeholder="Zip/postal" class="form-control input-sm parsley-validated " value="<?php echo $row['zip']; ?>" data-required="true" name="zip">
...
<!-- /.row -->
      ...
      <input type="text" class="tag-demo1"  id="tags1455191267153" style="display: none;" value="<?php echo $row['tags']; ?>" name="tags">

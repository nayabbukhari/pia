...
<!-- Mirrored from minetheme.com/Endless1.5.1/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2015 08:18:00 GMT -->
<head>
    <meta charset="utf-8">
						...
						<div class="row">
							<div class="col-xs-6 col-sm-12 col-md-6 text-center" >
								<a href="#" class="image-wrapper gallery-zoom cboxElement">
									<img src="<?php echo $row['path']; ?>" alt="User Avatar" style="height: 125px;" class="img-thumbnail">
								</a>
								<div class="seperator"></div>
								<div class="seperator"></div>
							</div><!-- /.col -->
							<div class="col-xs-6 col-sm-12 col-md-6" style="padding: 0px ! important;">
								<strong class="font-14"><?php echo $row['username']; ?></strong>
						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="edit">
										...
										<div class="panel-body">
											<div class="form-group">
                                                ...
                                                <input type="hidden" placeholder="Full name" value="<?php echo $row['id']; ?>" class="form-control input-sm parsley-validated " data-required="true" name="id">
													<input type="text" class="form-control input-sm" placeholder="Username" name="user_name" value="<?php echo $row['username']; ?>">
												</div><!-- /.col -->
											</div><!-- /form-group -->
										<!--	<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="email" name="email" readonly class="form-control input-sm" value="<?php echo $row['email']; ?>">
												</div><!-- /.col -->
											</div><!-- /form-group -->
                                            <div class="form-group">
												<label class="control-label col-md-2">Role</label>
												<div class="col-md-10">
													<input type="text" name="role" readonly class="form-control input-sm" value="<?php echo $row['role']; ?>">
												</div><!-- /.col -->
											</div><!-- /form-group -->
											<div class="form-group">
									...
									<div class="input-group">
										<input type="text" required  name="dob"  class="datepicker form-control" value="<?php echo $effectivedate; ?>">
...
<!-- Mirrored from minetheme.com/Endless1.5.1/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Oct 2015 08:18:02 GMT -->
</html>
<?php
if(isset($_GET['s']))
 {

...
$query = mysqli_query($con,"insert into pia_people(people_id,firstname,lastname,email,phone,address,city,zip,Prospect_Status,Customer_Status,tags,date_time) values('".$people_id."', '".$firstname."','".$lastname."','".$email."','".$ph."','".$Address."','".$City."','".$zip."','".$Prospect_Status."','".$c_status."','".$tags."',NOW())");
